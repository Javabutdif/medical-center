...
const DashboardLayout = () => {
  ...
  const getMobileSteps = (isAdmin) => [
    {
      ...
      content: `Welcome to the Medical Center ${isAdmin ? 'Admin' : 'Patient'} Portal. Let's get you started with a quick tour!`,
      placement: 'center',
      disableBeacon: true,
      spotlightPadding: 0,
    ...
    },
    {
      target: '.menu-toggle',
      title: 'Menu Access',
      content: 'Click here to open the navigation menu. This gives you access to all features.',
      placement: 'right',
      disableBeacon: true,
      spotlightPadding: 5,
    },
  ...
  const getDesktopSteps = (isAdmin) => [
    {
      ...
      content: `Let's take a quick tour of your ${isAdmin ? 'admin' : 'patient'} dashboard and its features.`,
      placement: 'center',
      disableBeacon: true,
      spotlightPadding: 0,
      styles: {
  ...
  const [steps, setSteps] = useState(isMobile ? getMobileSteps(getRoute() === "Admin") : getDesktopSteps(getRoute() === "Admin"));
  ...
  return (
    <div className="relative">
      ...
      />
      <DashboardHeader isOpen={isOpen} toggle={toggle} title={getTitle(location.pathname)} className="dashboard-header z-[1000]" />
      <DashboardAside
        isOpen={isOpen}
        toggle={toggle}
